      ...
      <div className="text-center mt-4">
        {type === 'login' ? (
          <p className="text-gray-600 dark:text-gray-400">
            ...
            <Link to="/register" className="ml-1 text-primary dark:text-primary-light hover:underline">
              Sign Up
            </Link>
          </p>
        ) : (
          <p className="text-gray-600 dark:text-gray-400">
            ...
            <Link to="/login" className="ml-1 text-primary dark:text-primary-light hover:underline">
              Sign In
            </Link>
          </p>
        )}
